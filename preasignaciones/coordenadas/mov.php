...
<body>
    ...
    <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="POST">
            ...
            ?>
                ...
                <tr>
                    ...
                    ?>
                        ...
                        <td class="bot"><a href="borrar.php?id_marcador=<?php echo $persona->id_marcador ?>">
        ...
        <tr>
            ...
            <td><input type='text' name=' Coordenadas' size='30' class='centrado'></td>
